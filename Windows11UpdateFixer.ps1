...
function Test-WindowsUpdateHealth {
    ...
    foreach ($server in $updateServers) {
        try {
            # Print THIS before the heavy command runs so the user sees progress
    ...
    $outputCallback.Invoke("`n=== REGISTRY SETTINGS ===`n")
    ...
    try {
        ...
        if (Test-Path $regPath) {
            $auPath = "$regPath\AU"
            if (Test-Path $auPath) {
                $auOptions = Get-ItemProperty -Path $auPath -ErrorAction Stop
                if ($auOptions.NoAutoUpdate -eq 1) {
                    $outputCallback.Invoke("  WARNING: Automatic Updates are DISABLED via Group Policy`n")
                } else {
                    $outputCallback.Invoke("  OK - Automatic Updates policy is enabled`n")
                }
            } else {
                $outputCallback.Invoke("  OK - No AU restrictions found`n")
            }
        } else {
            $outputCallback.Invoke("  OK - No restrictive Windows Update policies detected`n")
        }
    } catch {
        $outputCallback.Invoke("  INFO - Could not check registry (this is usually OK)`n")
    }
...
$form.Text = "Windows 11 Hosts File Manager - 25H2"
...
# FIXED: Increased top row height to 115 to prevent text clipping
...
$titlePanel.Padding = New-Object System.Windows.Forms.Padding(20, 18, 20, 10) # Added bottom padding

$titleLabel = New-Object System.Windows.Forms.Label
$titleLabel.Dock = [System.Windows.Forms.DockStyle]::Top
$titleLabel.AutoSize = $true
$titleLabel.Font = New-Object System.Drawing.Font("Segoe UI", 18, [System.Drawing.FontStyle]::Bold)
$titleLabel.Text = "🛡️ Windows 11 Hosts File Manager"
$titleLabel.ForeColor = [System.Drawing.Color]::White
$titleLabel.Padding = New-Object System.Windows.Forms.Padding(0, 0, 0, 8)
$titlePanel.Controls.Add($titleLabel)

$descLabel = New-Object System.Windows.Forms.Label
$descLabel.Dock = [System.Windows.Forms.DockStyle]::Bottom
$descLabel.AutoSize = $true
$descLabel.Font = New-Object System.Drawing.Font("Segoe UI", 10)
$descLabel.Text = "Control Microsoft endpoint access via Windows hosts file - Windows 11 25H2"
$descLabel.ForeColor = [System.Drawing.Color]::FromArgb(230, 240, 255)
# FIXED: Increased bottom padding to 10 to protect descenders (g, j, p, q, y)
$descLabel.Padding = New-Object System.Windows.Forms.Padding(0, 6, 0, 10) 
...
$statusLabel.Padding = New-Object System.Windows.Forms.Padding(0, 2, 0, 2)
...
$infoLabel.Padding = New-Object System.Windows.Forms.Padding(0, 2, 0, 2)
...
# Renamed variable from $Write-Console to $WriteConsole to fix parsing error
$WriteConsole = {
    param($text)
    $diagText.AppendText($text)
    $diagText.SelectionStart = $diagText.Text.Length
    $diagText.ScrollToCaret()
    $diagText.Refresh() # Forces immediate repaint
    [System.Windows.Forms.Application]::DoEvents() # Process message pump
}
...
$resetWUButton.Add_Click({
    $result = [System.Windows.Forms.MessageBox]::Show(
        "This will stop WU services, clear caches, and restart services. Continue?",
        "Confirm Reset",
    ...
    if ($result -eq [System.Windows.Forms.DialogResult]::Yes) {
        ...
        try {
            $WriteConsole.Invoke("PS> Stop-Service wuauserv, BITS, cryptsvc... ")
            ...
            $WriteConsole.Invoke("PS> Start-Service wuauserv, BITS, cryptsvc... ")
